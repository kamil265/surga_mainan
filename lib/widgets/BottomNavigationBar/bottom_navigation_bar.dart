...
import 'package:surga_mainan/widgets/BottomNavigationBar/bottom_curved_Painter.dart';
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isEnable ? DarkColor.primaryColor : DarkColor.backgroundColor2,
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                      color: isEnable ? DarkColor.backgroundColor2 : DarkColor.backgroundColor2,
                    ),
                  ],
        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                _icon(FontAwesomeIcons.box, _selectedIndex == 0, 0),
                _icon(FontAwesomeIcons.borderAll, _selectedIndex == 1, 1),
                _icon(FontAwesomeIcons.tags, _selectedIndex == 2, 2),
                _icon(FontAwesomeIcons.cartShopping, _selectedIndex == 3, 3),
              ],
            ),
          ),
        ],
